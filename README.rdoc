...
Endpoints where user authentication is not required uses HTTP Basic Authentication.
...
Endpoints where user authentication is not required uses a HTTP token Authentication.
